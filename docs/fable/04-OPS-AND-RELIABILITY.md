...
> **STATUS: MIXED** — restore runbook FIXED (`c880f88`, `docs/RUNBOOK-backups.md`). Error-rate alerting FIXED — created live in Sentry (Issue Alert 700530 + Metric Alert 10001509337 'Number of errors above 50 over past 1 hour', both enabled). Backups single-region OPEN — infra/policy decision.
