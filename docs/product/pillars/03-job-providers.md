...
*Source roster (post-2026-08-10 rotation): 40 classes / 41 registry keys / 40 instances. Backend tests: 217 `test_*.py` files; measure the collected count, never quote it (2 `live` deselected offline).*
