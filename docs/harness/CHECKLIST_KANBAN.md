...
- **Plans / billing lifecycle** — no Free/Premium tier yet (deferred; `docs/product/plans/2026-06-21-free-premium-plans.md`). The whole subscribe → upgrade → downgrade → cancel arc is absent.
...
| 13 | `/admin` + `/notifications` shown to logged-out users; no gate | Med | ✅ middleware now gates `/admin` + `/notifications` (`824879d`). *Decision (2026-06-21): **no admin/RBAC model** — access tiers will be **Free / Premium subscription plans** instead. Deferred — see `docs/product/plans/2026-06-21-free-premium-plans.md`.* |
...
4. ~~Admin role gate (#13)~~ — **dropped**. No admin model; access tiers will be **Free / Premium plans** (deferred — see `docs/product/plans/2026-06-21-free-premium-plans.md`).
...
- **Remaining = infra/scale, not bugs:** install **Redis + ARQ worker** to enable + test
  ...
  the #11 mitigation). **No admin/RBAC is planned** — instead access will be split into **Free / Premium subscription tiers** (deferred — see `docs/product/plans/2026-06-21-free-premium-plans.md`).
