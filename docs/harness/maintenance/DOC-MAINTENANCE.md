...
| ADRs (architecture decision records) | The decision log in `docs/product/VISION.md` — keep appending |
...
- `docs/harness/maintenance/DOC-HEALTH.md` — **written by the first Tier-3 audit; absent
  ...
  destination `/doc-audit` Step 5 writes to. Scorecard from each audit:
