...
- [ ] **Privacy notice draft** — `docs/compliance/privacy-notice.md` (content from `docs/product/research/pillar_3_batch_4.md §Privacy`)
...
After dogfood, verify these from `docs/product/research/pillar_3_batch_4.md`:
...
6. Update `docs/harness/IMPLEMENTATION_LOG.md` after each step completes.
