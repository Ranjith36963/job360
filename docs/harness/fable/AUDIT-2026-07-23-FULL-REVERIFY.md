...
The whole fable doc set (`docs/harness/FABLE_FINDINGS.md`, `fable-harness-plan.md`, and all
...
- **05-P2-BREACH — CLOSED (PR #114).** `docs/product/BREACH-RUNBOOK.md` exists.
