...
- [ ] Ops (`04` P2): write `docs/product/RUNBOOK-backups.md`, add a `/readyz` DB-backed uptime check + a Sentry error-rate alert, bump Node 20→22, commit `railway.json`, set worker `job_timeout`.
