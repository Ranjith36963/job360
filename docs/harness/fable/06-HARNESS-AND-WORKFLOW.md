...
- **What I saw:** most bulk is historical narrative that duplicates `docs/harness/IMPLEMENTATION_LOG.md`. Rule-count drift: header says "28", worker skill references "27". A 500-line context tax on every session.
