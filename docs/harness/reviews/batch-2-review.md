...
- **Reachability:** `/api/jobs/{id}/action`, `/api/actions`,
  ...
  pre-existing route.
- **Self-disclosure:** `docs/harness/IMPLEMENTATION_LOG.md` §"What got
...
- **Fix suggestion** — pick one:
  ...
  * **(b) Accept the deferral but reword the overclaim.**
    ...
    - Rename `docs/harness/IMPLEMENTATION_LOG.md` §"What shipped" item 3
...
- `docs/product/plans/batch-2-decisions.md:115-121` says the two columns
...
(round 2) / Not addressed" block of `docs/harness/IMPLEMENTATION_LOG.md` —
...
- `docs/harness/IMPLEMENTATION_LOG.md:291` — §"What shipped" item 3 reworded
...
- `docs/harness/IMPLEMENTATION_LOG.md:301` — §"What got deferred" item 1
...
`docs/product/plans/batch-2-decisions.md:122` — added a "REVISION 2026-04-18
...
From `docs/harness/IMPLEMENTATION_LOG.md` new §"Not addressed in round 2":
