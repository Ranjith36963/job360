...
Numbered work-units in the Job360 development history. Batch 2 added multi-user delivery; Batch 3 rotated the source roster (−3, +5) and added the tiered scheduler. Pillar 2 added 10 sub-batches (2.1–2.10) for the search-and-match engine upgrade. See `docs/IMPLEMENTATION_LOG.md`.
