...
| 8 | **CV diff + Keep** — original vs tailored side by side on the application page, changed lines marked, one Keep button that writes the artifact version; provenance colouring stays | 2 | Playwright: open, see a marked change on both panes, Keep, a new version appears with the right pane's text | #515 |
