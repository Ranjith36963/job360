...
| [`plans/2026-09-03-oauth-mcp/`](plans/2026-09-03-oauth-mcp/) | Slice 1 of the pivot: OAuth 2.1 authorization server for MCP clients (intent / spec with security section / plan + diff-vs-plan). |
