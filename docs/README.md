...
| [`STACK_checklist.md`](STACK_checklist.md) | Code-audited checklist: 41 built ✅ (with file proof) vs 10 to build ❌. |
| [`UPGRADE_PLAN.md`](UPGRADE_PLAN.md) | Phase 1–3 execution plan (Postgres → deploy → monitoring): TDD + multi-agent, money + keys per phase. |
| [`DEPLOY.md`](DEPLOY.md) | Railway deploy guide: services, env vars, how the live deploy is configured. |
