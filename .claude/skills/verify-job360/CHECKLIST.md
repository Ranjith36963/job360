...
- [ ] 4. Email verify — `POST /verify-email/request`, `/verify-email/confirm`, `GET /me/email-verified`; an unverified account must still 403 `email_not_verified` on every route declaring `require_verified_user`
