    ...
    <main className="mx-auto max-w-3xl px-6 py-16">
      ...
      <div className="mt-8 space-y-8 text-sm leading-relaxed text-muted-foreground">
        ...
        <section>
          ...
          <p className="mt-2">
            Job360 does not write your tailored CVs or cover letters. They
            are written either by you directly, or by your own connected AI
            assistant acting on your instructions. Job360&rsquo;s only role
            is to store, version, and render each document exactly as you or
            your assistant saved it. You must review a document before
            sending it to anyone. You are responsible for its accuracy and
            for what you submit to employers — a draft that misstates your
            experience is still your application. Documents you save belong
            to you.
          </p>
        </section>
