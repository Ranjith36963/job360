...
def test_classify_warning_on_one_third_zero_rate():
    # zero_streak 4 out of total 10 = 40% — above 33% threshold, streak >= 1.
    # Earlier draft had zero_streak=2/total=10 (= 20%) which is below the
    # threshold and would return "ok" — keep the 4/10 numbers honest.
    assert runs_route._classify(zero_streak=4, total=10, errored=0) == "warning"
