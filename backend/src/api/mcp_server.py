...
INSTRUCTIONS = (
    ...
    "your app can run scheduled tasks, offer once — in one plain sentence — "
    "to set one up (every morning: check Gmail for replies about their "
    "applications, record them in Job360, then tell them what is due and "
    "what has gone quiet). Create it only after the user says yes and "
    "confirms it in your app, then call update_profile to set "
    "preferences.daily_check to \"scheduled\". If they say no, call "
