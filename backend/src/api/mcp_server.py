...
Mounted at ``/api/mcp`` (streamable HTTP, stateless) so any MCP client — Claude
Code first — can bring a job, read the fit, tailor documents, record "I applied"
and read receipts, as the user, with a personal token.
