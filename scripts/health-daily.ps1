...
# Register it with Windows Task Scheduler — see docs/maintenance/HEALTH-SCHEDULE.md.
#
...
$prompt = "Run the /health skill: do the daily three-pillar system check and overwrite docs/maintenance/STATUS-DAILY.md with the report. Collect verbatim evidence. Mark any check that cannot run as UNKNOWN with the reason."
claude -p $prompt
