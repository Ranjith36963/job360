...
SYNONYM_GROUPS: list[set[str]] = [
    ...
    # ── Cross-domain additions (Phase 4B) ──
    ...
    {"DevSecOps", "DevSec Ops"},
    {"NoSQL", "No SQL", "Non-Relational"},
    {"Regulatory Affairs", "RA"},
    {"Clinical Trial", "Clinical Trials", "CT"},
    ...
    {"End of Life Care", "Palliative Care", "EOL Care"},
    ...
    {"Accounts Preparation", "Accounts Prep"},
    {"Tax Return", "Tax Returns", "Self Assessment"},
