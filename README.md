...
> **`NOTIFY_EMAIL` no longer notifies anyone** — declared in `core/settings.py`,
> read by nothing. See the DEAD rows in ARCHITECTURE.md's environment table.
>
